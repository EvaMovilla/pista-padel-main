...
class CourtsControllerTest {
    ...
    @Test
    @WithMockUser(username = "cliente@test.com", roles = "USER")
    ...
    @Test
    @WithMockUser(username = "admin@test.com", roles = "ADMIN")
    void deleteCourt_sinReservas_borradoFisicoRetorna204() throws Exception {
    ...
    @Test
    @WithMockUser(username = "admin@test.com", roles = "ADMIN")
    void deleteCourt_conReservas_desactivacionLogicaRetorna204() throws Exception {
